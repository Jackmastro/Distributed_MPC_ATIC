...
>>>>>>> Stashed changes
        cost =     household.Q .* norm(T_b - household.T_set).^2 ...
             ...
             + 0.5 * household.delta_m_R_pred * (norm(m_R - m_R_I_pred)).^2 ...
             + lambda_T_F_pred' * (T_F_pred_I - T_F_pred_pred)...
             + 0.5 * household.delta_T_F_pred * (norm(T_F_pred_I - T_F_pred_pred)).^2 ...
             + lambda_T_R_pred' * (T_R - T_R_I_pred)...
             + 0.5 * household.delta_T_R_pred * (norm(T_R - T_R_I_pred)).^2;  
...
>>>>>>> Stashed changes
        cost =     household.Q .* norm(T_b - household.T_set).^2 ...
             ...
             + 0.5 * household.delta_m_R_succ * (norm(m_R_succ_I - m_R_succ_succ)).^2 ...
             + lambda_T_F_succ' * (T_F - T_F_I_succ)...
             + 0.5 * household.delta_T_F_succ * (norm(T_F - T_F_I_succ)).^2 ....
